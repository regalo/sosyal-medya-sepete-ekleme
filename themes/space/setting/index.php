...
<link rel="stylesheet" type="text/css" href="../../themes/<?php echo ns_filter("themes");?>/setting/assets/style.css?v=<?php echo rand(1,99999);?>">
...
<!-- Değişen içerik alanı başlangıcı --->
<?php
...
?>
<script src="<?php echo ns_filter("siteurl");?>themes/space/setting/assets/over.js"></script>
