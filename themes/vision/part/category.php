	...
	<div class="container">
		<div class="intall reserve">
			...
			<div class="conts">
				...
				<div class="detabox">
					<h1><?php echo str_replace('Paketleri', '', $head);?></h1>
					<p><?php echo $description;?></p>
					<span class="countservices">
						<i class="fas fa-layer-group me-1"></i> <?php echo sprintf(_e("paket-mevcut",true),$count);?>
					</span>
				</div>
			</div>
		</div>
...
<section id="packlist" class="wow fadeInUp">
	<div class="container">
		...
		<?php $hcek = $db->query("select * from hizmetler where hz_id = '".$idd."'")->fetch(PDO::FETCH_ASSOC);

$hhcek = $db->query("select * from hizmetler where pt_tax = '".$hcek["pt_tax"]."' order by hz_id asc")->fetchAll(PDO::FETCH_ASSOC);
?>
<style>
#mobile-areaa{
		display:none;
        ...
        <div id="d"class="item" style="border-radius:11px;background-color:#fff; box-shadow:0 20px 30px 0 rgb(187 194 205 / 16%); padding:20px;">
          <div class="row">
            <div class="col-lg-2 icons d-flex align-items-center">
                <i class="iconum fa <?php echo $value["hz_icon"];?>"
	...
	<style>
        ...
        .fa-eye{
            ...
            <div class="col-lg-6 texts d-flex align-items-center">
              ...
              font-weight:500;
              "
              ><strong><?php echo $value["hz_adi"];?></strong></h2>
            </div>
            <div class="col-lg-4 prices d-flex align-items-center">
               	<a href="https://socialmister.com/<?php echo $value["hz_pri"]."/";?>"class="sc-button btn btn-sm btn-bordered-white style letter p-3"class="p-wall"class="service-box" style="background: url(images/bg.png), linear-gradient(to bottom, #0f6b73 0%, #0f6b73 100%);background-size: 200%;border-radius: 10px;">
	...
	.fa-telegram{
		color: blue;
            ...
            <div style="justify-content:center;" class="col-lg-4 prices d-flex align-items-center">
               	<a href="https://socialmister.com/<?php echo $value["hz_pri"]."/"; ?>" class="sc-button btn btn-sm btn-bordered-white style letter p-2"class="p-wall"class="service-box" style="background: url(images/bg.png), linear-gradient(to bottom, #0f6b73 0%, #0f6b73 100%);background-size: 200%;border-radius: 10px;">
<span style="color:white" size:"15px">Paketleri incele</span></a>
              </div>
          </div>
        </div>
      </div>
			...
			<div class="col-md-12">
				<div class="post-area">
					<div class="post-content mt-3">
						<div style="display:none;" id="acKapa" class="post-body">
							<?php echo $content;?>
						</div>
					</div>
				</div>
